...
<display:table pagesize="5" name="endorsements" id="row" requestURI="endorsement/customer,handy-worker/list.do" >
	...
	<jstl:choose>
    	<jstl:when test="${row.handyWorkerSender.email==myEmail || row.customerSender.email==myEmail}">
			<a href="endorsement/customer,handy-worker/edit.do?endorsementId=${row.id}"><spring:message code="endorsement.edit" /></a> 
    	</jstl:when>    
    	<jstl:otherwise>
     	   <a>-</a>
    	</jstl:otherwise>
	...
	<jstl:choose>
    	<jstl:when test="${row.handyWorkerSender.email==myEmail || row.customerSender.email==myEmail}">
			<a href="endorsement/customer,handy-worker/delete.do?endorsementId=${row.id}"><spring:message code="endorsement.delete" /></a> 
    	</jstl:when>    
    	<jstl:otherwise>
     	   <a>-</a>
    	</jstl:otherwise>
