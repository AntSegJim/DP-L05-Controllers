...
public interface HandyWorkerRepository extends JpaRepository<HandyWorker, Integer> {
	...
	@Query("select a.handyWorker.email from Application a join a.fixUpTask f where f.customer = ?1")
	public Collection<HandyWorker> getHandyWorkerInvolveInAnyOfHisFixUpTask(Integer customerId);
